...
# =========================================================
# AI-Photo-Picker 每日渲染脚本
# =========================================================

# 修改为你的项目目录
PROJECT_DIR="E:/ESP32/ESP-PROJECTS/ESP32-S3-PhotoPainter/AI-Photo-Picker"

VENV_DIR="$PROJECT_DIR/venv"
PYTHON_BIN="$VENV_DIR/bin/python"
LOG_DIR="$PROJECT_DIR/logs"

LOCK_DIR="$PROJECT_DIR/tmp/picker_render.lockdir"
...
"$PYTHON_BIN" main.py render >> "$LOG_DIR/render.log" 2>&1
